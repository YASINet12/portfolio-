...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-950 to-black relative overflow-hidden transition-colors duration-300">
      ...
      {/* Hero Section */}
      <section id="hero" className={`hero-section relative min-h-screen flex items-center justify-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="container mx-auto px-4 py-20">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="hero-title text-4xl xs:text-5xl sm:text-6xl md:text-7xl font-bold text-white dark:text-gray-100 mb-4 bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent animate-gradient">
              Yassine ET-TAHERY
            </h1>
            <p className="hero-subtitle text-xl xs:text-2xl sm:text-2xl md:text-3xl text-blue-300 dark:text-blue-400 font-medium mb-6">
